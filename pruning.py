...
argparser.add_argument("-m", "--checkpoint", default="./saved_models/model_ckpt_dense",
...
save_models_paths = save_model + "/" + str(percent)
...
if args.first_round == True:
    ...
    saver.save(sess, save_model + "/model_ckpt_dense")
...
if args.second_round == True:
    ...
    # save model objects to serialized format
    saver.save(sess, save_models_paths + "/model_ckpt_dense_pruned")
    ...
    # saver.save(sess, key)
    saver.save(sess, save_models_paths + "/model_ckpt_dense_retrained")
...
if args.third_round == True:
    ...
    if args.second_round == False:
        saver.restore(sess, save_models_paths  + "/model_ckpt_dense_pruned")
    ...
    final_saver.save(sess, save_models_paths + "/model_ckpt_sparse_retrained") 
